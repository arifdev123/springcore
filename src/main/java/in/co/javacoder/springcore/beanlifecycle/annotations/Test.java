package in.co.javacoder.springcore.beanlifecycle.annotations;
...
public class Test {
	public static void main(String[] args) {
		...
		ConfigurableApplicationContext context = new ClassPathXmlApplicationContext("in/co/javacoder/springcore/beanlifecycle/annotations/springconfig.xml");
		...
		Patient ticket = (Patient) context.getBean("ticket");
